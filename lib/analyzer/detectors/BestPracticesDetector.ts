...
\`\`\``,
                severity: 'low',
                docLink: 'https://discord.js.org/docs/packages/discord.js/main/BaseManager:class',
            })
        }
...
\`\`\``,
                    severity: 'low',
                    docLink: 'https://discord.js.org/docs/packages/discord.js/main/PermissionFlagsBits:enum',
                })
            }
        }
...
\`\`\``,
                    severity: 'low',
                    docLink: 'https://discord.js.org/docs/packages/discord.js/main/InteractionReplyOptions:interface',
                })
            }
        }
...
Interactions expire after 3 seconds if not responded to.`,
                    severity: 'medium',
                    docLink: 'https://discord.js.org/docs/packages/discord.js/main/CommandInteraction:class#deferReply',
                })
            }
        }

        // Check for using components without ActionRow
        if ((code.includes('ButtonBuilder') || code.includes('SelectMenuBuilder')) && !code.includes('ActionRowBuilder')) {
            const lineNum = lines.findIndex(line => line.includes('ButtonBuilder') || line.includes('SelectMenuBuilder')) + 1
            suggestions.push({
                type: 'error',
...
\`\`\``,
                severity: 'critical',
                line: lineNum,
                docLink: 'https://discord.js.org/docs/packages/builders/main/ActionRowBuilder:class',
            })
        }
...
\`\`\``,
                    severity: 'medium',
                    docLink: 'https://discord.js.org/docs/packages/discord.js/main/DiscordAPIError:class',
                })
            }
        }
...
\`\`\``,
                severity: 'medium',
                docLink: 'https://discord.js.org/docs/packages/discord.js/main/Client:class#ready',
            })
        }
...
\`\`\``,
                severity: 'low',
                docLink: 'https://discord.js.org/docs/packages/discord.js/main/Events:enum',
            })
        }
